...
When someone adds you as an **assignee** on a card, you get an in-app notification (and an email if you've opted that on). You're never notified about assigning a card to yourself. Manage these under [notification preferences](https://github.com/monark-community/app/blob/develop/docs/user-guide/account/the-account-section-account/notifications.md).
